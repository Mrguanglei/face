...
LOCALES : Locales =\
{
	'en':
	{
		...
		'uis':
		{
			...
			'job_manager_job_action_dropdown': 'JOB ACTION',
	...
	'zh':
	{
		...
		'python_not_supported': 'Python 版本不受支持，请升级到 {version} 或更高版本',
		...
		'copying_image': '正在复制图片，分辨率 {resolution}',
		'copying_image_succeeded': '复制图片成功',
		'copying_image_failed': '复制图片失败',
		'finalizing_image': '正在完成图片处理，分辨率 {resolution}',
		'finalizing_image_succeeded': '完成图片处理成功',
		'finalizing_image_skipped': '跳过图片完成步骤',
		...
		'processing_image_succeeded': '图片处理成功，耗时 {seconds} 秒',
		...
		'specify_image_or_video_output': '指定输出目录中的图片或视频',
		'match_target_and_output_extension': '确保目标和输出文件扩展名一致',
		'no_source_face_detected': '未检测到源人脸',
		'processor_not_loaded': '处理器 {processor} 加载失败',
		'processor_not_implemented': '处理器 {processor} 未正确实现',
		'ui_layout_not_loaded': 'UI 布局 {ui_layout} 加载失败',
		'ui_layout_not_implemented': 'UI 布局 {ui_layout} 未正确实现',
		'stream_not_loaded': '流模式 {stream_mode} 加载失败',
		...
		'job_step_added': '已添加步骤到任务 {job_id}',
		'job_step_not_added': '添加步骤到任务 {job_id} 失败',
		'job_remix_step_added': '已从任务 {job_id} 混音步骤 {step_index}',
		'job_remix_step_not_added': '从任务 {job_id} 混音步骤 {step_index} 失败',
		'job_step_inserted': '已插入步骤 {step_index} 到任务 {job_id}',
		'job_step_not_inserted': '插入步骤 {step_index} 到任务 {job_id} 失败',
		...
		'help':
		{
			...
			'temp_path': '指定临时资源目录',
			'jobs_path': '指定存储任务的目录',
			'source_paths': '选择图片或音频路径',
			'target_path': '选择图片或视频路径',
			'output_path': '指定目录中的输出图片或视频',
			'source_pattern': '选择图片或音频模式',
			'target_pattern': '选择图片或视频模式',
			'output_pattern': '指定图片或视频模式',
			...
			'face_landmarker_score': '根据置信度分数过滤检测到的面部关键点',
			'face_selector_mode': '使用基于参考的追踪或简单匹配',
			...
			'execution_providers': '使用不同的推理提供商 (选项: {choices}, ...)',
			...
			'job_list': '按状态列出任务',
			'job_create': '创建一个草稿任务',
			'job_submit': '提交草稿任务到队列',
			'job_submit_all': '提交所有草稿任务到队列',
			'job_delete': '删除草稿、队列中、失败或已完成的任务',
			'job_delete_all': '删除所有草稿、队列中、失败和已完成的任务',
			'job_add_step': '向草稿任务添加步骤',
			'job_remix_step': '从草稿任务混音之前的步骤',
		...
		'uis':
		{
			...
			'face_mask_regions_checkbox_group': '人脸掩码部位',
			...
			'face_selector_order_dropdown': '人脸选择器排序',
			...
			'detect_target_faces_button': '检测目标人脸',
			'target_faces_gallery': '检测到的目标人脸',
			'face_count_text': '人脸数量',
			'target_face_label': '目标人脸',
			'source_face_label': '替换为'
		}
	}
}
