...
from facefusion.utils import curl_builder
from facefusion.utils.filesystem import get_file_name, get_file_size, is_file, remove_file
from facefusion.utils.hash_helper import validate_hash
...
def resolve_download_url(base_name : str, file_name : str) -> Optional[str]:
	download_providers = state_manager.get_item('download_providers') or []
...
def resolve_download_url_by_provider(download_provider : DownloadProvider, base_name : str, file_name : str) -> Optional[str]:
	download_provider_value = facefusion.utils.choices.download_provider_set.get(download_provider)
