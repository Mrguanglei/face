...
from facefusion.utils.cli_helper import render_table
from facefusion.utils.download import conditional_download, resolve_download_url
from facefusion.face.face_store import clear_static_faces
from facefusion.utils.filesystem import get_file_extension
from facefusion.types import BenchmarkCycleSet
from facefusion.media.vision import count_video_frame_total, detect_video_fps
...
def run() -> Iterator[List[BenchmarkCycleSet]]:
	...
	benchmarks = []
	target_paths = [ facefusion.utils.choices.benchmark_set.get(benchmark_resolution) for benchmark_resolution in benchmark_resolutions if benchmark_resolution in facefusion.utils.choices.benchmark_set ]
