...
from facefusion import config, logger, state_manager
...
from facefusion.media import video_manager
from facefusion.utils import content_analyser, inference_manager
from facefusion.utils.common_helper import get_first, is_macos
from facefusion.utils.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from facefusion.utils.execution import has_execution_provider
from facefusion.face.face_analyser import get_average_face, get_many_faces, get_one_face, scale_face
from facefusion.face.face_helper import paste_back, warp_face_by_face_landmark_5
from facefusion.face.face_masker import create_area_mask, create_box_mask, create_occlusion_mask, create_region_mask
from facefusion.face.face_selector import select_faces, sort_faces_by_order
from facefusion.utils.filesystem import filter_image_paths, has_image, in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from facefusion.utils.model_helper import get_static_model_initializer
...
from facefusion.utils.program_helper import find_argument_group
from facefusion.utils.thread_helper import conditional_thread_semaphore
...
from facefusion.media.vision import read_static_image, read_static_images, read_static_video_frame, unpack_resolution
...
def forward_swap_face(source_face : Face, target_face : Face, crop_vision_frame : VisionFrame) -> VisionFrame:
	...
	if is_macos() and has_execution_provider('coreml') and model_type in [ 'ghost', 'uniface' ]:
		face_swapper.set_providers([ facefusion.utils.choices.execution_provider_set.get('cpu') ])
