...
from facefusion.utils.common_helper import create_int_metavar, is_macos
...
from facefusion.face.face_analyser import scale_face
from facefusion.face.face_helper import merge_matrix, paste_back, scale_face_landmark_5, warp_face_by_face_landmark_5
from facefusion.face.face_masker import create_box_mask, create_occlusion_mask
from facefusion.face.face_selector import select_faces
from facefusion.utils.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
...
from facefusion.utils.thread_helper import thread_semaphore
...
from facefusion.media.vision import match_frame_color, read_static_image, read_static_video_frame
...
def forward(crop_vision_frame : VisionFrame, extend_vision_frame : VisionFrame, age_modifier_direction : AgeModifierDirection) -> VisionFrame:
	...
	if is_macos() and has_execution_provider('coreml'):
		age_modifier.set_providers([ facefusion.utils.choices.execution_provider_set.get('cpu') ])
