...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(facefusion.utils.choices.execution_thread_count_range),
		minimum = facefusion.utils.choices.execution_thread_count_range[0],
		maximum = facefusion.utils.choices.execution_thread_count_range[-1]
	)
