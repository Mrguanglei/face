...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = facefusion.utils.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(facefusion.utils.choices.system_memory_limit_range),
		minimum = facefusion.utils.choices.system_memory_limit_range[0],
		maximum = facefusion.utils.choices.system_memory_limit_range[-1],
