...
from facefusion.utils.common_helper import is_windows
from facefusion.utils.filesystem import get_file_extension, is_image, is_video
...
from facefusion.media.video_manager import get_video_capture
...
def restrict_video_fps(video_path : str, fps : Optional[Fps]) -> Fps:
	if is_video(video_path):
		video_fps = detect_video_fps(video_path)
		if fps is not None and video_fps < fps:
			return video_fps
		return video_fps
	return fps or 30.0
