...
from facefusion.utils import inference_manager
...
def create_area_mask(crop_vision_frame : VisionFrame, face_landmark_68 : FaceLandmark68, face_mask_areas : List[FaceMaskArea]) -> Mask:
	...
	for face_mask_area in face_mask_areas:
		if face_mask_area in facefusion.utils.choices.face_mask_area_set:
			landmark_points.extend(facefusion.utils.choices.face_mask_area_set.get(face_mask_area))
...
def create_region_mask(crop_vision_frame : VisionFrame, face_mask_regions : List[FaceMaskRegion]) -> Mask:
	...
	region_mask = numpy.isin(region_mask.argmax(0), [ facefusion.utils.choices.face_mask_region_set.get(face_mask_region) for face_mask_region in face_mask_regions ])
